 ...
 */
public class Calculette1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        op1.setText("2");
        op1.setToolTipText("Entrer un réel avec ',' comme marque décimale");
        ...
        op2.setText("3");
        op2.setToolTipText("Entrer un réel avec ',' comme marque décimale");
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        ...
                        .add(27, 27, 27)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(resul, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                            .add(op2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                            .add(op1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 188, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .add(41, 41, 41))
    ...
    private void lireEtValider() {
     ok = true;
     try {
         s = new java.util.Scanner(  op1.getText( ) );
         oper1 = s.nextDouble(); // à cause de la ',' à la place du '.';
    ...
    try {
        s = new java.util.Scanner(  op2.getText( ) );
        oper2 = s.nextDouble(); // à cause de la ',' à la place du '.';
    }catch (java.util.InputMismatchException e) {
        op2.setText("???");
        resul.setText(" ");
        if ( ok ) {
    ...
    private void division(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_division
     ...
     jLabel2.setText( "/" ); 
     if( ok ) {
      resul.setText( String.format("%.3f", oper1 / oper2 ) );
      op1.selectAll();
      op1.requestFocus();
     }
            ...
            public void run() {
             try
             {
              ...
              //        ("com.sun.java.swing.plaf.windows.WindowsLookAndFeel");
                ...
                new Calculette1().setVisible(true);
             }catch ( Exception e) { } 
            }
        });
    }
